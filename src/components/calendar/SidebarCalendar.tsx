    ...
    <div className="p-4">
      <Calendar
        ...
        classNames={{
          ...
          head_cell: "text-gray-500 rounded-md font-normal text-xs h-8 flex items-center justify-center uppercase flex-1",
          row: "flex w-full justify-between mt-1",
          cell: "h-8 text-center text-sm p-0 relative flex items-center justify-center flex-1 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
