      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        <div className="md:col-span-8">
          <Card className="overflow-hidden shadow-sm border border-gray-100">
            <CardContent className="p-0">
              <div className="flex">
                <div className="bg-gradient-to-br from-purple-400 to-purple-600 p-8 w-full md:w-1/3 flex flex-col justify-center">
                ...
                <div className="w-full md:w-2/3 p-4 bg-white">
                  <Calendar
                    ...
                    modifiersClassNames={{
                      hasAppointment: 'bg-gradient-to-br from-purple-400 to-purple-600 text-white rounded-full',
                    }}
                  />
                </div>
              </div>
        ...
        <div className="md:col-span-4">
          <Card className="h-full shadow-sm border border-gray-100 overflow-hidden">
            <CardHeader className="bg-gradient-to-br from-purple-400 to-purple-600 border-b border-gray-100 p-6">
