    ...
    <div className="max-w-lg mx-auto mb-8 sm:mb-12">
      {hasNoResults ? (
        <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
          <p className="text-gray-500 text-base text-center">No emails or documents found matching "<span className="text-purple-600 font-medium">{searchQuery}</span>"</p>
        ...
        <div className="bg-white rounded-lg p-3 shadow-sm border border-gray-200">
          <p className="text-gray-700 text-sm font-medium text-center">
            Found <span className="text-purple-600 font-medium">{searchResultsCount}</span> email{searchResultsCount !== 1 ? 's' : ''} and <span className="text-purple-600 font-medium">{documentCount}</span> document{documentCount !== 1 ? 's' : ''} for "<span className="text-purple-600 font-medium">{searchQuery}</span>" 
