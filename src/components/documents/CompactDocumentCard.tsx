...
const CompactDocumentCard = ({ attachment, layout = 'grid' }: CompactDocumentCardProps) => {
  ...
  if (layout === 'list') {
    return (
      <Card className="group hover:shadow-md transition-all duration-200 bg-white border-gray-200/60">
  ...
  // Grid layout (compact)
  return (
    <Card className="group hover:shadow-lg transition-all duration-200 bg-white border-gray-200/60 h-full">
      <CardContent className="p-4 flex flex-col h-full">
        {/* File Icon and Name */}
        <div className="flex items-start gap-3 mb-3">
          <div className={`w-8 h-8 rounded-lg ${fileInfo.bgColor} flex items-center justify-center flex-shrink-0`}>
