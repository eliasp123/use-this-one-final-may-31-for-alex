...
const CompactDocumentCard = ({ attachment, layout = 'grid' }: CompactDocumentCardProps) => {
  ...
  if (layout === 'grid') {
    return (
      <Card className="w-72 bg-gradient-to-br from-amber-50 via-stone-50 to-orange-50/60 shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-amber-200/50">
        {/* File Icon Header */}
