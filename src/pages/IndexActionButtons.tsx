  ...
  return (
    <div className="flex items-center justify-center gap-8">
      ...
      <button
        ...
        className="flex items-center gap-2 text-gray-600 hover:text-purple-600 transition-colors duration-200 text-base font-normal underline decoration-gray-300 hover:decoration-purple-600 underline-offset-4"
      >
      ...
      <button
        ...
        className="flex items-center gap-2 text-gray-600 hover:text-amber-600 transition-colors duration-200 text-base font-normal underline decoration-gray-300 hover:decoration-amber-600 underline-offset-4"
      >
